      ...
      <div style={{ border: '1px solid var(--border)', borderRadius: 8, overflow: 'hidden', background: 'var(--surface)' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
          ...
          <tbody>
            ...
            {!loading && bugs.length === 0 && <tr><td colSpan={5} style={{ padding: 40, textAlign: 'center', color: 'var(--text-faint)' }}>No bugs found.</td></tr>}
            {!loading && bugs.map((bug, i) => (
              ...
              >
                ...
                <td style={{ ...td, color: 'var(--text-faint)', fontSize: 13 }}>{formatDate(bug.created_at)}</td>
              </tr>
            ))}
          </tbody>
        </table>
...
const sel = { padding: '8px 12px', borderRadius: 6, border: '1px solid var(--border)', fontSize: 14, background: 'var(--surface)' };
